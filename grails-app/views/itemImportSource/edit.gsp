...
<html>
	...
	<body>
		<a href="#edit-itemImportSource" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-itemImportSource" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${itemImportSourceInstance?.version}" />
				<fieldset class="form">
