	...
	<body>
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<fieldset>
					<g:form class="form-horizontal" action="edit" id="${magentoItemImportInstance?.id}" >
						<g:hiddenField name="version" value="${magentoItemImportInstance?.version}" />
						<fieldset>
							<f:all bean="magentoItemImportInstance"/>
